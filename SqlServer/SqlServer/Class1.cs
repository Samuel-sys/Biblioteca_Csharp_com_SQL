...
namespace SqlServer
{
    ...
    public class Comand
    {
        ...
        public static bool Insert(string comando, string RouteConnect)
        {
            ...
            {
                //ponte de conexão
                SqlConnection PonteDeConexao = new SqlConnection(RouteConnect);

                //ponte de comando SqlServer
                SqlCommand PonteDeComando = new SqlCommand(comando, PonteDeConexao);
        ...
        public static bool Update(string comando, string RouteConnect)
        {
            ...
            if (comando.Substring(0, 6).ToUpper() == "UPDATE")
            {
                ...
                //ponte de conexão
                SqlConnection conn = new SqlConnection(RouteConnect);
        ...
        public class Select
        {
            ...
            {
                //ponte de conexão
                SqlConnection conexao = new SqlConnection(RouteConnect);
